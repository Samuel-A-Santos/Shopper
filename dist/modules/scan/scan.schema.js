...
exports.ListSchema = exports.ConfirmSchema = exports.ScanSchema = void 0;
...
exports.ListSchema = joi_1.default.object({
    customer_code: joi_1.default.string().required().messages({
        "string.base": `"customer_code" must be a string`,
        "any.required": `"customer_code" is required`
    }),
    measure_type: joi_1.default.string().valid("WATER", "GAS").insensitive().required().messages({
        "any.only": `"measure_type" must be either "WATER" or "GAS"`,
        "string.base": `"measure_type" must be a string`
    })
});
